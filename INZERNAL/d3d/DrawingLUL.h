...
#include <Windows.h>
	...
	inline void DrawStrokeText(int x, int y, RGBA* color, const char* str)
	{
		ImFont a;
	...
	inline void DrawNewText(int x, int y, RGBA* color, const char* str)
	{
		ImFont a;
		std::string utf_8_1 = std::string(str);
		std::string utf_8_2 = string_To_UTF8(utf_8_1);
	...
	inline void DrawRect(int x, int y, int w, int h, RGBA* color, int thickness)
	{
	...
	inline void DrawCircleFilled(int x, int y, int radius, RGBA* color)
	{
	...
	inline void DrawCircle(int x, int y, int radius, RGBA* color, int segments)
	{
	...
	inline void DrawTriangle(int x1, int y1, int x2, int y2, int x3, int y3, RGBA* color, float thickne)
	{
	...
	inline void DrawTriangleFilled(int x1, int y1, int x2, int y2, int x3, int y3, RGBA* color)
	{
	...
	inline void DrawLine(int x1, int y1, int x2, int y2, RGBA* color, int thickness)
	{
	...
	inline void DrawCornerBox(int x, int y, int w, int h, int borderPx, RGBA* color)
	{
