...
bool elements::tab(const char* name, bool boolean)
{
    ...
    window->DrawList->AddRectFilled(ImVec2(rect.Max.x + 4, rect.Min.y + 6), ImVec2(rect.Max.x + 8, rect.Max.y - 6), ImColor(147 / 255.0f, 190 / 255.0f, 66 / 255.0f, it_anim->second.rect_opacity), 7.0f);
...
bool elements::subtab(const char* name, bool boolean)
{
    ...
    window->DrawList->AddRectFilled(ImVec2(rect.Max.x + 5, rect.Min.y + 9), ImVec2(rect.Max.x + 8, rect.Max.y - 9), ImColor(147 / 1.f, 190 / 1.f, 66 / 1.f, it_anim->second.rect_opacity), 10.0f);
